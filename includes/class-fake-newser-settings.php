 ...
 * Settings class.
 */
class Fake_newser_Settings {

	/**
	 * The single instance of Fake_newser_Settings.
	 *
	 * @var     object
	 * @access  private
	 * @since   1.0.0
	...
	private function settings_fields() {
		...
		$settings['extra'] = array(
			...
			'fields'      => array(
				...
				array(
					'id'          => 'multi_select_box',
					'label'       => __( 'A Multi-Select Box', 'fake-newser' ),
					'description' => __( 'A standard multi-select box - the saved data is stored as an array.', 'fake-newser' ),
					'type'        => 'select_multi',
					'options'     => array(
						'linux'   => 'Linux',
						'mac'     => 'Mac',
	...
	public function settings_page() {
		...
		$html      = '<div class="wrap" id="' . $this->parent->_token . '_settings">' . "\n";
			$html .= '<h2>' . __( 'Plugin Settings', 'fake-newser' ) . '</h2>' . "\n";
		...
		if ( is_array( $this->settings ) && 1 < count( $this->settings ) ) {
			...
			$html .= '<form method="post" action="options.php" enctype="multipart/form-data">' . "\n";
				...
				$html     .= '<p class="submit">' . "\n";
					...
					$html .= '<input name="Submit" type="submit" class="button-primary" value="' . esc_attr( __( 'Save Settings', 'fake-newser' ) ) . '" />' . "\n";
				$html     .= '</p>' . "\n";
			$html         .= '</form>' . "\n";
		$html             .= '</div>' . "\n";
	...
	/**
	 * Main Fake_newser_Settings Instance
	 *
	 * Ensures only one instance of Fake_newser_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Fake_newser()
	 * @param object $parent Object instance.
	 * @return object Fake_newser_Settings instance
	 */
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html( __( 'Cloning of Fake_newser_API is forbidden.' ) ), esc_attr( $this->parent->_version ) );
	} // End __clone()
	...
	public function __wakeup() {
		_doing_it_wrong( __FUNCTION__, esc_html( __( 'Unserializing instances of Fake_newser_API is forbidden.' ) ), esc_attr( $this->parent->_version ) );
	} // End __wakeup()
