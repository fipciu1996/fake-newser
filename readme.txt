...
Installing "Fake newser" can be done either by searching for "Fake newser" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
